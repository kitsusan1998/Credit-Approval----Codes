...
with st.form("my_form"):
    ...
    open_end_line_of_credit = st.number_input('Please input open-end_line_of_credit')
    co_applicant_credit_score_type = st.radio('Please specific co_applicant_credit_score_type',['1.0', '2.0', '3.0', '8.0', '9.0', '10.0'])
    co_applicant_age_above62 = st.radio('Is co-applicant age above 62?',[True, False])

    lien_status = st.number_input('Please input tract_one_to_four_family_homes')
    debt_to_income_ratio = st.radio('debt_to_income_ratio',['>60%', '36%-<50%'])
